...
// const JobOpeningsBase = ({ filterMode, pageSize = 6 }) => {
...
//                 className="w-full max-w-2xl relative bg-white rounded-2xl shadow-2xl overflow-hidden max-h-[90vh] overflow-y-auto"
//               >
//                 {/* Close */}
//                 <button
